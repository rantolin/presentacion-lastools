...
\begin{frame}
  ...
  \begin{minipage}{0.65\textwidth}
    \uncover<3->{\put{\includefigure{image/edge}}}
    \uncover<4->{\put{\includefigure{image/grow}}}
    \uncover<5->{\put{\includefigure{image/corr}}}
  \end{minipage}
\end{frame}
%%==================================================================Sb
\subsection{\path{v.outlier}}
%%==================================================================F 
...
\end{frame}
%%==================================================================Sb
\subsection{\path{v.lidar.edgedetection}}
%%==================================================================F 
...
\end{frame}
%%==================================================================Sb
\subsection{\path{v.lidar.growing}}
%%==================================================================F 
\begin{frame}[fragile,shrink=10]
...
\end{frame}
%%==================================================================Sb
\subsection{\path{v.lidar.correction}}
%%==================================================================F 
\begin{frame}[fragile,shrink=5]
